...
const VideoCart = ({ item }) => {
  ...
  return (
    <div className="w-94 cursor-pointer my-2">
      <img
        className='rounded-xl w-full h-80 object-cover' // Ensure the height is consistent and use object-cover
        src={item.snippet.thumbnails.high ? item.snippet.thumbnails.high.url : item.snippet.thumbnails.medium.url}
        alt="ytvideo"
      />
      <div>
